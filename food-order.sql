...
(12, 'Administrator', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin'),
(18, 'Brim Smoke', 'Ekoms', '202cb962ac59075b964b07152d234b70', 'admin');
...
(13, 'Burgers', 'Food_Category_197.jpg', 'Yes', 'Yes'),
...
(35, 'BM1', 'Regular Burger w/ Fries, and Coke.', 90.00, 'Food-Name-6786.jpg', 13, 'Yes', 'Yes'),
...
CREATE TABLE `tbl_manager` (
  ...
  `role` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'manager'
...
INSERT INTO `tbl_manager` (`id`, `full_name`, `username`, `password`, `role`) VALUES
(1, 'Jett Dash', 'jett', 'acb47de2536f24caf5e9887bd9ec1652', 'manager'),
(2, 'Brim Smoke', 'nigga1', 'acb47de2536f24caf5e9887bd9ec1652', 'manager'),
(20, 'Jett Dash', 'mon', 'acb47de2536f24caf5e9887bd9ec1652', 'manager');
...
(19, 'BM1', 100.00, 2, 200.00, '2025-01-17 05:45:48', 'Delivered', 25),
(20, 'BM1', 90.00, 1, 90.00, '2025-01-17 08:52:21', 'Delivered', 25),
(21, 'Mozzarella Pizza', 550.00, 1, 550.00, '2025-01-17 10:56:14', 'Delivered', 25);
